...
export default function BuscarWorkspacePage({
  ...
  const resultados = workspaces.filter((workspace) =>
    workspace.nombre.toLowerCase().includes(busqueda.toLowerCase())
  );
    ...
    <div className="max-w-5xl mx-auto">
      ...
      <div className="relative mb-6">
        ...
        <input
          ...
          className="w-full bg-white border border-gray-200 rounded-xl pl-12 pr-4 py-3 outline-none focus:border-rose-500"
        />
      </div>
        ...
        {resultados.map((workspace) => (
          ...
          >
            ...
            <div className="flex gap-2">
              ...
              <button
                onClick={() => eliminarWorkspace(workspace.id)}
